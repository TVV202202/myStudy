...
public class OrderQueue {
    ...
    public static void main(String[] args) {
        Order o1 = new Order(300, 1);
        Order o2 = new Order(500, 2);
        Order o3 = new Order(21000, 3);
        Order o4 = new Order(20000, 4);
        Order o5 = new Order(10000, 5);
        Order o6 = new Order(12000, 6);
        Order o7 = new Order(60000, 7);
        Order o8 = new Order(15000, 8);
